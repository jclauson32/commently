...
class ScrapeCreatorClient:
    ...
    def get_instagram_comments(
        self, post_url: str, cursor: str = None
    ) -> CommentsResponse:
        """
        ...
        res = self._scrape_creators_request(
            "instagram/post/comments", data, method="GET"
        )
    ...
    def _scrape_creators_request(self, endpoint: str, data: dict, method: str = "POST"):
        ...
        headers = {"x-api-key": self.api_key, **self._scrape_creators_extra_headers()}
        try:
